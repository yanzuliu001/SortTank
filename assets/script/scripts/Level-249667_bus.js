...
var H = (function(t) {
            ...
            return __generator(this, function(s) {
                switch (s.label) {
                    case 0:
                        if (this.isWaterMode) {
                            ...
                            if (this.isHighSpeedRailway) {
                                ...
                                return (
                                    (t = $userManager.User.getTempData($userConst.TempData.CURRENT_LEVEL) || 1) > 50 &&
                                    (t %= 50),
                                    (this.dict.bg.width = 1e4),
                                    t >= 41 ?
                                    ((this.dict.bg.color = new cc.Color(254, 205, 136)), [
                                        4,
                                        $assetManager.default.getRes("gameBundle", "prefab/map/SandBg", cc.Prefab)
                                    ]) : [3, 3]
                                );
                            }
                        }
                    ...
                    case 3:
                        if (t >= 31) {
                            return (
                                (this.dict.bg.color = new cc.Color(254, 205, 136)), [4, $assetManager.default.getRes("gameBundle", "prefab/map/SnowBg", cc.Prefab)]
                            );
                        } else {
                            return [3, 6];
                        }
                    ...
                    case 6:
                        if (t >= 21) {
                            return (
                                (this.dict.bg.color = new cc.Color(227, 196, 163)), [4, $assetManager.default.getRes("gameBundle", "prefab/map/DoorYellow", cc.Prefab)]
                            );
                        } else {
                            return [3, 9];
                        }
                    ...
                    case 9:
                        if (t >= 11) {
                            return (
                                (this.dict.bg.color = new cc.Color(160, 193, 122)), [4, $assetManager.default.getRes("gameBundle", "prefab/map/GrassBg", cc.Prefab)]
                            );
                        } else {
                            return [3, 12];
                        }
                ...
                switch (s.label) {
                    ...
                    case 1:
                        for (t = s.sent(), n = 0; n < this.dict.parkingRoot.children.length; n++) {
                            ...
                            a.getChildByName("videoLock") &&
                                ((a
                                        .getChildByName("videoLock")
                                        .getChildByName("text")
                                        .getComponent(cc.Label).fontSize = 35),
                                    (a
                                        .getChildByName("videoLock")
                                        .getChildByName("text")
                                        .getComponent(cc.Label).lineHeight = 40),
                                    (a.getChildByName("videoLock").getChildByName("text").width = 90),
                                    (a.getChildByName("videoLock").opacity = 200));
                        }
                    ...
                    case 2:
                        ...
                        return $localStorageManager.default.get($localStorageConst.default.UnlockParking) ?
                            ((o.active = !0),
                                (o.children[1].getComponent(cc.Label).string =
                                    "" + $localStorageManager.default.get($localStorageConst.default.UnlockParking)), [4, $assetManager.default.getRes("gameBundle", "texture/lock", cc.Texture2D)]) : [3, 4];
                    case 3:
                        for (r = s.sent(), n = 0; n < this.dict.parkingRoot.children.length; n++) {
                            ...
                            a.getChildByName("videoLock") &&
                                (a
                                    .getChildByName("videoLock")
                                    .getChildByName("icon")
                                    .getComponent(cc.Sprite).spriteFrame = new cc.SpriteFrame(r));
                        }
                        return [3, 6];
                    case 4:
                        if (i) {
                    ...
                    case 5:
                        ...
                        s.label = 6;
                    case 6:
                        this.dict.parkingRoot.children[0].getChildByName("empty").getComponent(cc.Sprite).spriteFrame =
                            new cc.SpriteFrame(t);
                        o.on(
                            cc.Node.EventType.TOUCH_START,
                            function() {
                                $toastManager.default.show(
                                    $languageManager.default.formatStr("可以解锁一个新的停车位")
                                );
                            },
                            this
                        );
            ...
            return __generator(this, function(n) {
                switch (n.label) {
                    case 0:
                        ...
                        return t ?
                            ((this.dict.parkingRoot.parent.getChildByName("unlock_pack").active = !0),
                                (this.dict.parkingRoot.parent
                                    .getChildByName("unlock_pack")
                                    .children[1].getComponent(cc.Label).string = "" + t), [4, $assetManager.default.getRes("gameBundle", "texture/lock", cc.Texture2D)]) : [3, 2];
                    case 1:
                        for (o = n.sent(), i = 0; i < this.dict.parkingRoot.children.length; i++) {
                            (r = this.dict.parkingRoot.children[i]).opacity = 255;
                            r.getChildByName("videoLock") &&
                                (r
                                    .getChildByName("videoLock")
                                    .getChildByName("icon")
                                    .getComponent(cc.Sprite).spriteFrame = new cc.SpriteFrame(o));
                        }
                        return [3, 6];
                    case 2:
                        if (e) {
                            return (
                                (this.dict.parkingRoot.parent.getChildByName("unlock_pack").active = !1), [4, $assetManager.default.getRes("gameBundle", "texture/lock", cc.Texture2D)]
                            );
                        } else {
                            return [3, 4];
                        }
                ...
                switch (o.label) {
                    case 0:
                        for (
                            ...
                            ($platformManager.Platform.getConfig().flag.includes("ios") ||
                                this.isHighSpeedRailway) &&
                            ((this.dict.door.getComponent(cc.Sprite).enabled = !1),
                                (this.dict.door.getChildByName("bg").active = !1),
                                (this.dict.doorOutside.active = !1),
                                (this.dict.door2.getComponent(cc.Sprite).enabled = !1),
                                (this.dict.door2.active = !1),
                                this.dict.board && (this.dict.board.active = !1)),
                            cc.view.getFrameSize().width / cc.view.getFrameSize().height < 0.5 &&
                            this.dict.carRoot.getComponent($level_249667_oblique.default) &&
                            this.dict.carRootBg2 &&
                            (this.dict.carRootBg2.children[0].y -= 50),
                            e = 0; e < this.dict.personPosRoot.children.length; e++
                        ) {
                        ...
                        this.levelDataJSON = JSON.parse(
                            JSON.stringify($level_249667_busConfig.levelData[this.levelID])
                        );
                ...
                switch (s.label) {
                    case 0:
                        if ($platformManager.Platform.getConfig().flag.includes("ios") || this.isHighSpeedRailway) {
                            return (
                                (this.dict.personAmount.parent.active = !1), [4, $assetManager.default.getRes("iosBundle", "prefab/Mark", cc.Prefab)]
                            );
                        } else {
                            return [3, 4];
                        }
                    ...
                    case 3:
                        for (
                            r = s.sent(), n = cc.instantiate(r), a = 0; a < this.dict.personPosRoot.children.length; a++
                        ) {
                ...
                switch (i.label) {
                    case 0:
                        if ("f27597" != this.folder) {
                            ...
                            return (
                                this.dict.carPrefab.getChildByName("061").destroy(),
                                this.dict.carPrefab.getChildByName("062").destroy(),
                                this.dict.carPrefab.getChildByName("063").destroy(), [4, $assetManager.default.getRes("ttBundle", "prefab/blockMan/061", cc.Prefab)]
                            );
                        }
                    case 1:
                        t = i.sent();
                    ...
                    case 0:
                        if (this.dict.transportAmount) {
                            if ($platformManager.Platform.getConfig().flag.includes("ios") || this.isHighSpeedRailway) {
                                return [
                                    4,
                                    $assetManager.default.getRes("iosBundle", "prefab/TransportAmountRoot", cc.Prefab)
                                ];
                            } else {
                                return [3, 2];
                            }
    ...
    e.prototype.addTurntableCar = function() {
        if (this.dict.turntableRoot) {
            ...
            for (var t = 0; t < this.dict.turntableRoot.children.length; t++) {
                ...
                this.turntableCarArr = this.turntableCarArr.concat(
                    e.getComponent($level_249667_turntable.default).getCars()
                );
            }
        }
    };
                ...
                switch (s.label) {
                    case 0:
                        if ($platformManager.Platform.getConfig().hasCoin) {
                            return (
                                console.log("addCoin"), [4, $assetManager.default.getRes("gameBundle", "prefab/coin/coinRoot0", cc.Prefab)]
                            );
                        } else {
                            return [2];
                        }
                ...
                switch (s.label) {
                    case 0:
                        ...
                        if (i) {
                            ...
                            a.getComponent($level_249667_carItem.default).isRichCar = t.getComponent(
                                $level_249667_carItem.default
                            ).isRichCar;
                        } else {
                            if (t.getComponent($level_249667_carItem.default).isFireEngine) {
                                ...
                                if (t.getComponent($level_249667_carItem.default).isPoliceCar) {
                                    ...
                                    if (t.getComponent($level_249667_carItem.default).isRichCar) {
                                        ...
                                        a = t.getComponent($level_249667_carItem.default).isTramcar ?
                                            (4 != e && 5 != e) || 2 != o ?
                                            (4 != e && 5 != e) || 1 != o ?
                                            cc.instantiate(this.dict.carPrefab.getChildByName("132" + n)) :
                                            cc.instantiate(
                                                this.dict.carPrefab.getChildByName("13" + e + n + "-1")
                                            ) :
                                            cc.instantiate(
                                                this.dict.carPrefab.getChildByName("13" + e + n + "-0")
                                            ) :
                                            cc.instantiate(this.dict.carPrefab.getChildByName("02" + n));
                                    }
                                }
                            }
                        }
                        a.getComponent($level_249667_carItem.default).isTramcar = t.getComponent(
                            $level_249667_carItem.default
                        ).isTramcar;
                        a.getComponent($level_249667_carItem.default).tramcarPosIndex = t.getComponent(
                            $level_249667_carItem.default
                        ).tramcarPosIndex;
                        ...
                        if (
                            t.getComponent($level_249667_carItem.default).carState !=
                            $level_249667_busConfig.CarState.InRoadRight &&
                            t.getComponent($level_249667_carItem.default).carState !=
                            $level_249667_busConfig.CarState.InRoadLeft
                        ) {
                            //
                        } else {
                            this.updateCarWeight();
                        }
                        a.getComponent($level_249667_carItem.default).carState = t.getComponent(
                            $level_249667_carItem.default
                        ).carState;
                        a.active = !1;
                        ...
                        a.getComponent($level_249667_carItem.default).carColor = t.getComponent(
                            $level_249667_carItem.default
                        ).carColor;
                        l = 2;
                        if (a.getComponent($level_249667_carItem.default).isTramcar) {
                        ...
                        if (4 == e || 5 == e) {
                            ...
                            if (0 == o) {
                                ...
                                if (
                                    a.getComponent($level_249667_carItem.default).carState ==
                                    $level_249667_busConfig.CarState.OnBottomLeft
                                ) {
                                    a.position = cc.v2(t.x - t.width / l, t.y);
                                } else {
                                    if (
                                        a.getComponent($level_249667_carItem.default).carState ==
                                        $level_249667_busConfig.CarState.OnBottomRight
                                    ) {
                                        a.position = cc.v2(t.x + t.width / l, t.y);
                                    } else {
                                        1 == o ?
                                            ((h = this.dict.road.parent.convertToWorldSpaceAR(
                                                    this.dict.road.position
                                                )),
                                                (c = a.parent.convertToNodeSpaceAR(h)),
                                                (a.position = cc.v2(t.x + t.width / l, c.y))) :
                                            ((h = this.dict.road.parent.convertToWorldSpaceAR(
                                                    this.dict.road.position
                                                )),
                                                (c = a.parent.convertToNodeSpaceAR(h)),
                        ...
                        if (
                            a.getComponent($level_249667_carItem.default).carState ==
                            $level_249667_busConfig.CarState.GoingParking
                        ) {
                        ...
                        g = function(e) {
                            ...
                            try {
                                if (i && i.getComponent($level_249667_carItem.default)) {
                                    i.getComponent($level_249667_carItem.default).carState =
                            ...
                            if (
                                ...
                                m.addTailGasSpine(a);
                                cc.tween(a)
                                    .to(p / a.getComponent($level_249667_carItem.default).speed, {
                                        position: f
                                    })
                                    .call(function() {
                                        if (a.getComponent($level_249667_carItem.default).isFireEngine) {
                                            a.getComponent($level_249667_carItem.default).carState =
                                                $level_249667_busConfig.CarState.WaterSpray;
                                            a.getChildByName("penshui").active = !0;
                                            cc.tween(a.parking.getChildByName("fireSpine"))
                                                .to(1, {
                                                    opacity: 0
                                                })
                                                .start();
                                            ...
                                            console.log(
                                                "isRichCar",
                                                a.getComponent($level_249667_carItem.default).isRichCar
                                            );
                                            if (a.getComponent($level_249667_carItem.default).isRichCar) {
                                                m.changeCar(
                                                    ...
                                                    6,
                                                    0,
                                                    "116" + a.getComponent($level_249667_carItem.default).lenImgName
                                                );
                                            } else {
                                                if (a.getComponent($level_249667_carItem.default).isTramcar) {
                                                    m.changeCar(
                                                        ...
                                                        6,
                                                        0,
                                                        "136" + a.getComponent($level_249667_carItem.default).lenImgName
                                                    );
                                                } else {
                                                    m.changeCar(
                                                        a,
                                                        6,
                                                        0,
                                                        "06" + a.getComponent($level_249667_carItem.default).lenImgName
                                                    );
                                                }
                                            }
                                        }
                                ...
                                if (a.parking) {
                                    if (1 == a.getComponent($level_249667_carItem.default).lenImgName) {
                                        ...
                                        if (2 == a.getComponent($level_249667_carItem.default).lenImgName) {
                                            (v = a.parking.convertToWorldSpaceAR(cc.v2(0, -3))),
                                            (a.getChildByName("car").angle = -27.592);
                                        } else {
                                            (v = a.parking.convertToWorldSpaceAR(cc.v2(3, 3))),
                                            (a.getChildByName("car").angle = -27.592);
                                        }
                                    }
                                    var C = a.parent.convertToNodeSpaceAR(v);
                                    a.getComponent($level_249667_carItem.default).carState =
                                        $level_249667_busConfig.CarState.Parking;
                                    a.stopAllActions();
                                ...
                                a.getComponent($level_249667_carItem.default).carState ==
                                $level_249667_busConfig.CarState.GoingRoad
                            ) {
                                ...
                                m.addTailGasSpine(a);
                                cc.tween(a)
                                    .by(p / a.getComponent($level_249667_carItem.default).speed, {
                                        y: p
                                    })
                                    .call(function() {
                                        m.collision(a);
                                ...
                                m.addTailGasSpine(a);
                                cc.tween(a)
                                    .to(2250 / a.getComponent($level_249667_carItem.default).speed, {
                                        position: g
                                    })
                                    .start();
                            }
                        ...
                        return t.getComponent($level_249667_carItem.default).carState !=
                            $level_249667_busConfig.CarState.OutParking ? [3, 2] : [4, this.addMannedImg(a, r, e, n)];
                    case 1:
                        s.sent();
                        g(null);
                        return [3, 3];
    ...
    e.prototype.fireEngineLeave = function(t) {
        ...
        cc.tween(t)
            .to(2250 / t.getComponent($level_249667_carItem.default).speed, {
                position: o
            })
            .start();
            ...
            if (r) {
                ...
                if (s.x >= c.x) {
                    ...
                    if (i.getComponent($level_249667_carItem.default).isRichCar) {
                        (i.getComponent($level_249667_carItem.default).lenImgName = 1),
                        this.changeCar(
                            i,
                            1,
                            2,
                            "111" + i.getComponent($level_249667_carItem.default).lenImgName + "-0"
                        );
                    } else {
                        this.changeCar(i, 1, 2, "01" + i.getComponent($level_249667_carItem.default).lenImgName + "-0");
                    }
                    ...
                    if (i.getComponent($level_249667_carItem.default).isRichCar) {
                        ...
                        this.changeCar(
                            ...
                            1,
                            1,
                            "111" + i.getComponent($level_249667_carItem.default).lenImgName + "-1"
                        );
                    } else {
                        this.changeCar(i, 1, 1, "01" + i.getComponent($level_249667_carItem.default).lenImgName + "-1");
                    }
    ...
    e.prototype.onLevelReady = function() {
        this.dict.personPrefab.children[0]
            .getComponent(sp.Skeleton)
            .setAnimationCacheMode(sp.Skeleton.AnimationCacheMode.PRIVATE_CACHE);
        this.initView();
    };
            ...
            return __generator(this, function(G) {
                switch (G.label) {
                    case 0:
                        if (this.dict.carRoot.getComponent($level_249667_carSquare.default)) {
                            this.dict.carRoot
                                .getComponent($level_249667_carSquare.default)
                                .init(this.levelDataJSON.carSquare, this);
                        }
                        if (this.dict.carRoot.getComponent($level_249667_oblique.default)) {
                            this.dict.carRoot
                                .getComponent($level_249667_oblique.default)
                                .init(this.levelDataJSON.centerSquare, this.levelDataJSON.oblique, this);
                        }
                        if (this.dict.carRoot.getComponent($level_249667_uTransport.default)) {
                            for (b = 0; b < this.dict.carRoot.children.length; b++) {
                                (S = this.dict.carRoot.children[b]).getComponent(
                                    $level_249667_carItem.default
                                ).isUTransportCar_noIn = !0;
                            }
                            this.dict.carRoot
                                .getComponent($level_249667_uTransport.default)
                                .init(this.levelDataJSON.uTransport, this);
                        }
                        if (this.dict.guide) {
                            this.scheduleOnce(function() {
                        ...
                        for (
                            this.addTurntableCar(), this.addTransportCar(), k = 0; k < this.dict.parkingRoot.childrenCount; k++
                        ) {
                            (N = this.dict.parkingRoot.children[k]).active &&
                                N.getChildByName("empty").active &&
                                !N.getChildByName("fireSpine") &&
                                ((N.isEmpty = !0), this.parkingNodes.push(N));
                            N.getChildByName("videoLock") &&
                                (N.getChildByName("videoLock").getChildByName("icon").scale = 0.8);
                        }
                        if (this.isDebug) {
                            t = [];
                        ...
                        if (this.dict.carParkRoot) {
                            ...
                            for (b = 0; b < this.dict.carParkRoot.children.length; b++) {
                                (S = this.dict.carParkRoot.children[b])
                                .getComponent($level_249667_carpark.default)
                                    .initData(this.levelDataJSON.carpark[b], this);
                        ...
                        if (this.levelDataJSON.blackAmount && !e.length) {
                            if (this.levelDataJSON.blackAmount >= this.between2_4CarArr.length) {
                                for (b = 0; b < this.between2_4CarArr.length; b++) {
                                    (S = this.between2_4CarArr[b]).getComponent(
                                        $level_249667_carItem.default
                                    ).isBlackCar = !0;
                                    e.push(S.getComponent($level_249667_carItem.default).carID);
                                }
                            } else {
                                f = this.getRandomDistinctElements(
                        ...
                        if (
                            (C = $userManager.User.getTempData($userConst.TempData.CURRENT_LEVEL) || 1) >= y &&
                            0 != y &&
                            C > 1
                        ) {
                            this.sortColor_new = $tools.default.shuffleArray(
                                JSON.parse(JSON.stringify($level_249667_busConfig.sortColor))
                            );
                        ...
                        if (0 == v.length || (C >= y && 0 != y && C > 1)) {
                            ...
                            for (k = 0; k < this.carNodeArr.length; k++) {
                                ...
                                N.getComponent($level_249667_carItem.default).isPoliceCar &&
                                    (P = $level_249667_busConfig.CarColor.Police);
                                N.getComponent($level_249667_carItem.default).isRichCar &&
                                    (P = $level_249667_busConfig.CarColor.Gold);
                                v.push(P);
                                this.setCarColorImg(N, P);
                                null ==
                                    (x =
                                        this.levelDataJSON.carWeight[
                                            N.getComponent($level_249667_carItem.default).path - 1
                                        ]) && (x = 0);
                                if (P == $level_249667_busConfig.CarColor.Gold) {
                                    this.carWeight[P] +=
                                        x * N.getComponent($level_249667_carItem.default).emptySeatAmount * 2;
                                } else {
                                    this.carWeight[P] +=
                                        x * N.getComponent($level_249667_carItem.default).emptySeatAmount;
                                }
                            }
                            ...
                            for (k = 0; k < this.carNodeArr.length; k++) {
                                N = this.carNodeArr[k];
                                P = v[k];
                                e.includes(N.getComponent($level_249667_carItem.default).carID) &&
                                    (N.getComponent($level_249667_carItem.default).isBlackCar = !0);
                                N.getComponent($level_249667_carItem.default).isPoliceCar &&
                                    (P = $level_249667_busConfig.CarColor.Police);
                                N.getComponent($level_249667_carItem.default).isRichCar &&
                                    (P = $level_249667_busConfig.CarColor.Gold);
                        ...
                        for (
                            ...
                            console.log("颜色", $level_249667_busConfig.colorDes),
                            console.log("人数", this.colorPersonArr),
                            b = 0; b < $level_249667_busConfig.colorDes.length; b++
                        ) {
                    ...
                    case 3:
                        ...
                        this.dict.door2.getComponent(cc.Sprite).enabled = !1;
                        M = Math.abs(-837);
                        cc.tween(this.dict.highSpeedRail)
                            .to(M / this.highSpeedRailSpeed, {
                                x: -13
                            })
                            .call(function() {
                                E.dict.highSpeedRail2Root.active = !0;
                                cc.tween(E.dict.leftDoor)
                                    .by(0.3, {
                                        x: -34
                                    })
                                    .start();
                                cc.tween(E.dict.rightDoor)
                                    .by(0.3, {
                                        x: 34
                                    })
                                    .call(function() {
                                            ...
                                            if (o.sent()) {
                                                if (t != this.allPersonAmount) {
                                                    ...
                                                    if (this.isFail) {
                                                        ...
                                                        return (
                                                            (this.isFail = !0),
                                                            (e = this.allPersonAmount), [4, this.timer(0.5)]
                                                        );
                                                    }
                                                }
                                            } else {
    ...
    e.prototype.initWaterModeEffect = function() {
        if (this.isWaterMode) {
            var t = function(t) {
                var o = e.dict.carRoot.children[t];
    ...
    e.prototype.checkHasCarMove = function() {
        ...
        for (var o = 0; o < e.length; o++) {
            var i = e[o];
            if (
                i.getComponent($level_249667_carItem.default).carState != $level_249667_busConfig.CarState.Idle &&
                i.getComponent($level_249667_carItem.default).carState != $level_249667_busConfig.CarState.Normal &&
                i.getComponent($level_249667_carItem.default).carState != $level_249667_busConfig.CarState.Parking
            ) {
                t = !0;
                break;
            }
    ...
    e.prototype.checkHasCarMoveAmount = function() {
        ...
        for (var o = 0; o < e.length; o++) {
            ...
            if (
                ...
                i.active &&
                i.getComponent($level_249667_carItem.default).carState != $level_249667_busConfig.CarState.Idle &&
                i.getComponent($level_249667_carItem.default).carState != $level_249667_busConfig.CarState.OutParking
            ) {
                t += 1;
            }
        }
            ...
            this.scheduleOnce(function() {
                if (t.sortPersonNodes.length) {
                    ...
                    if (t.sortPersonNodes[o]) {
                        ...
                        cc.tween(t.dict.faceSpine.parent)
                            .delay(3)
                            .call(function() {
    ...
    e.prototype.checkHasCollision = function(t) {
        ...
        for (var h = 0; h < l.length; h++) {
            ...
            if (
                p &&
                p != t &&
                p.getComponent($level_249667_carItem.default).carState == $level_249667_busConfig.CarState.Idle &&
                p.active &&
                !p.getComponent($level_249667_carItem.default).isTransportCar &&
                !p.getComponent($level_249667_carItem.default).isUTransportCar
            ) {
                var d;
                var u;
                var g;
            ...
            for (var i = 0; i < o.length; i++) {
                ...
                if (cc.Intersection.pointInPolygon(e, this.getWPosByPolygon(n))) {
                    if (
                        this.dict.carRoot.getComponent($level_249667_oblique.default) &&
                        null != r.carSquareCol &&
                        this.dict.carRoot.getComponent($level_249667_oblique.default).isAnim
                    ) {
                        return;
                    }
                    ...
                    if (
                        this.isRemove &&
                        r.getComponent($level_249667_carItem.default).carState ==
                        $level_249667_busConfig.CarState.Idle &&
                        !this.removePropUsing &&
                        !r.obliqueHead &&
                        !r.getComponent($level_249667_carItem.default).isFireEngine
                    ) {
                    ...
                    if (
                        r.getComponent($level_249667_carItem.default).carState != $level_249667_busConfig.CarState.Idle
                    ) {
                        return;
                    }
                    ...
                    if (
                        ...
                        cc.tween(r)
                            .to(2250 / r.getComponent($level_249667_carItem.default).speed, {
                                position: v
                            })
                            .start();
                        ...
                        if (y) {
                            if (
                                (r.getChildByName("chain") &&
                                    1 ==
                                    r.getChildByName("chain").getComponent($level_249667_chain.default).linkType) ||
                                (y.getChildByName("chain") &&
                                    1 == y.getChildByName("chain").getComponent($level_249667_chain.default).linkType)
                            ) {
                                y.getComponent($level_249667_carItem.default).carState =
                                    $level_249667_busConfig.CarState.Normal;
                                console.log("平行加入检测");
                            }
                            this.moveCarAmount += 1;
                        ...
                        if (
                            s &&
                            ((s.getChildByName("chain") &&
                                    1 == s.getChildByName("chain").getComponent($level_249667_chain.default).linkType) ||
                                (r.getChildByName("chain") &&
                                    1 == r.getChildByName("chain").getComponent($level_249667_chain.default).linkType))
                        ) {
                            s.getComponent($level_249667_carItem.default).carState =
                                $level_249667_busConfig.CarState.Normal;
                            this.moveCarAmount += 1;
                            cc.tween(s)
                                .to(2250 / s.getComponent($level_249667_carItem.default).speed, {
                                    position: v
                                })
                                .start();
                        }
                    ...
                    if (
                        r.getComponent($level_249667_carItem.default).isTransportCar ||
                        r.getComponent($level_249667_carItem.default).isUTransportCar ||
                        1 != r.getComponent($level_249667_carItem.default).path
                    ) {
                        //
                    } else {
                        this.addTailGasSpine(r);
        ...
        if (this.dict.bulldozerRoot) {
            for (var e = 0; e < this.dict.bulldozerRoot.children.length; e++) {
                ...
                if ("bulldozer" == o.name) {
                    ...
                    if (
                        cc.Intersection.pointInPolygon(t, this.getWPosByPolygon(i)) &&
                        o.getComponent($level_249667_bulldozer.default).state ==
                        $level_249667_busConfig.BulldozerState.Idle
                    ) {
                        console.log("点击到推土机");
                        o.getComponent($level_249667_bulldozer.default).state =
                            $level_249667_busConfig.BulldozerState.Normal;
                        ...
                        cc.tween(o)
                            .to(2250 / o.getComponent($level_249667_bulldozer.default).bulldozerSpeed, {
                                position: n
                            })
                            .start();
                    }
    ...
    e.prototype.setCarColorImg = function(t, e) {
        ...
        if (
            t.getComponent($level_249667_carItem.default).isFireEngine ||
            t.getComponent($level_249667_carItem.default).isPoliceCar ||
            t.getComponent($level_249667_carItem.default).isRichCar
        ) {
    ...
    e.prototype.updateCarWeight = function() {
        ...
        var o = function(o) {
            ...
            if (
                r &&
                r.getComponent($level_249667_carItem.default) &&
                r.getComponent($level_249667_carItem.default).carState == $level_249667_busConfig.CarState.Idle &&
                !r.getComponent($level_249667_carItem.default).isTransportCar &&
                !r.getComponent($level_249667_carItem.default).isUTransportCar
            ) {
                ...
                if (r.getComponent($level_249667_carItem.default).carColor == $level_249667_busConfig.CarColor.Gold) {
                    i.carWeight[r.getComponent($level_249667_carItem.default).carColor] +=
                        a * r.getComponent($level_249667_carItem.default).emptySeatAmount * 2;
                } else {
                    i.carWeight[r.getComponent($level_249667_carItem.default).carColor] +=
                        a * r.getComponent($level_249667_carItem.default).emptySeatAmount;
                }
            }
        };
        var i = this;
            ...
            for (var r = 0; this.sortPersonNodes.length < this.uiShowPersonAmount;) {
                ...
                for (var h = 0; h < a; h++) {
                    if (t) {
                        var p = void 0;
                        (p =
                            n >= $level_249667_busConfig.CarColor.Police ?
                            cc.instantiate(this.dict.careerPrefab) :
                            cc.instantiate(this.dict.personPrefab)).oldPosIndex = -1;
                        ...
                        if (d < 0) {
                            ...
                            d >= 5 &&
                                (this.setColorPersonImg(
                                    ...
                                    p.children[0].getComponent(sp.Skeleton).setAnimation(0, "daiji_ce", !0));
                        }
                                    ...
                                    if (!r.active && !r.targetPerson && ((r.targetPerson = !0), (i = r))) {
                                        ...
                                        cc.tween(s)
                                            ...
                                            .call(function() {
                                                ...
                                                cc.tween(s)
                                                    .to(n / (0.6 * e.personSpeed), {
                                                        x: r.x
                                                    })
                                                    .call(function() {
                                                        s.children[0]
                                                            .getComponent(sp.Skeleton)
                                                            .setAnimation(0, "pao_zheng", !0);
                                                    })
                                                    ...
                                                    .call(function() {
                                                        ...
                                                        if ($platformManager.Platform.getConfig().hasCoin) {
                                                            ...
                                                            i.parent.parent
                                                                .getChildByName("coinRoot")
                                                                .children[t].getComponent(sp.Skeleton)
                                                                .setAnimation(0, "animation2", !1);
                                                        }
                                                    })
                                                    .start();
                                            })
                    ...
                    if (a >= n.childrenCount) {
                        ...
                        var p = setInterval(function() {
                            if (!t.checkCarBlock(l)) {
                                ...
                                r.getComponent($level_249667_carItem.default).carState =
                                    $level_249667_busConfig.CarState.GoingOutParking;
                                if (0 == e) {
                                    i.active = !1;
                                }
                                i.isEmpty = !0;
                                ...
                                cc.tween(r)
                                    .to((r.height / 2 / r.getComponent($level_249667_carItem.default).speed) * 1.3, {
                                        position: l
                                    })
                                    .call(function() {
                                        t.checkRes();
                                        r.getComponent($level_249667_carItem.default).carState =
                                            $level_249667_busConfig.CarState.OutParking;
                                        if (r.getComponent($level_249667_carItem.default).isRichCar) {
                                            ...
                                            t.changeCar(
                                                ...
                                                1,
                                                1,
                                                "01" + r.getComponent($level_249667_carItem.default).lenImgName + "-1"
                                            );
                                        }
                                    })
                                    .start();
    ...
    e.prototype.setColorPersonImg = function(t, e, o, i) {
        ...
        if (t + 1 == 10) {
            r = "skin_" + (t + 1) + i;
            "" != i &&
                (e.children[0].getComponent(sp.Skeleton).setSkin("" + r),
                    (e.children[0].getComponent(sp.Skeleton).defaultSkin = r));
        } else {
            if (t + 1 == 11) {
                (r = "skin_" + (t + 1) + i),
                "" != i &&
            ...
            for (var i = 0; i < this.carNodeArr.length; i++) {
                ...
                if (r.carColor == t) {
                    ...
                    for (var s = r.seatTotalAmount; s > 0;) {
                        ...
                        if (
                            t != $level_249667_busConfig.CarColor.Police &&
                            t != $level_249667_busConfig.CarColor.Gold
                        ) {
                            //
                        } else {
                            c = 2;
    ...
    e.prototype.getPersonColor = function() {
        ...
        for (var e = 0; e < this.colorTypeAmount; e++) {
            ...
            0 != this.currentPersonColorAmount[e] &&
                ...
                (console.log($level_249667_busConfig.colorDes[e] + "颜色已经满元"), (this.allWeight[e] = 0));
        }
        return this.randomByWeight(
            new Array($level_249667_busConfig.colorDes.length).fill(1).map(function(t, e) {
                return e;
            }),
            this.allWeight
        );
    ...
    e.prototype.setCarID = function() {
        ...
        this.carNodeArr.sort(function(t, e) {
            return (
                t.getComponent($level_249667_carItem.default).path - e.getComponent($level_249667_carItem.default).path
            );
        });
    ...
    e.prototype.getOtherCarByDistance = function(t, e) {
        ...
        for (var r = 0; r < i.length; r++) {
            ...
            if (
                n &&
                n != t &&
                n.getComponent($level_249667_carItem.default).carState == $level_249667_busConfig.CarState.Idle &&
                n.active &&
                !n.getComponent($level_249667_carItem.default).isTransportCar &&
                !n.getComponent($level_249667_carItem.default).isUTransportCar
            ) {
    ...
    e.prototype.getPath = function(t) {
        ...
        if (
            s.getComponent($level_249667_carItem.default).leftObliqueCar ||
            s.getComponent($level_249667_carItem.default).rightObliqueCar
        ) {
            return 1;
        }
                    ...
                    case 0:
                        if (this.isSorting) {
                            ...
                            return (
                                (this.isSorting = !0),
                                (this.isSortAnim = !0),
                                (t = 1.5), [4, $assetManager.default.getRes("gameBundle", "prefab/item/StarPrefab", cc.Prefab)]
                            );
                        }
                    case 1:
                        e = r.sent();
                        ...
                        cc.tween(this.node)
                            ...
                            .call(function() {
                                ...
                                console.log(
                                    "排队颜色顺序",
                                    i.fetchMaxIndex(i.allWeight, $level_249667_busConfig.colorDes.length)
                                );
                                ...
                                for (r = 0; r < i.sortPersonNodes.length; r++) {
                                    ...
                                    for (
                                        var s = t[n]; 0 == e[s] &&
                                        ((s = t[(n += 1)]), !(n >= $level_249667_busConfig.colorDes.length - 1));
                    ...
                    case 0:
                        if (this.isSorting) {
                            ...
                            return (
                                (this.isSorting = !0),
                                (this.isSortAnim = !0),
                                (e = 1.5), [4, $assetManager.default.getRes("gameBundle", "prefab/item/StarPrefab", cc.Prefab)]
                            );
                        }
                    case 1:
                        o = n.sent();
    ...
    e.prototype.func_updateCar = function() {
        ...
        for (var o = 0; o < e.length; o++) {
            if (!(l = e[o]).active ||
                l.getComponent($level_249667_carItem.default).carState != $level_249667_busConfig.CarState.Idle ||
                l.getComponent($level_249667_carItem.default).isTransportCar ||
                l.getComponent($level_249667_carItem.default).isUTransportCar ||
                l.getComponent($level_249667_carItem.default).isBlackCar
            ) {
                //
            } else {
                t.push(l);
        ...
        for (var i = 0; i < t.length; i++) {
            ...
            for (var n = 0; n < t.length; n++) {
                ...
                if (
                    r != a &&
                    r.getComponent($level_249667_carItem.default).seatTotalAmount ==
                    a.getComponent($level_249667_carItem.default).seatTotalAmount &&
                    r.getComponent($level_249667_carItem.default).carColor !=
                    a.getComponent($level_249667_carItem.default).carColor &&
                    !r.isExchange &&
                    !a.isExchange &&
    ...
    e.prototype.func_removeCar = function() {
        ...
        t.children[1].getComponent(cc.Label).string =
            $languageManager.default.formatStr("可拎出任意一辆汽车至VIP车位消除");
        t.y = 301.643;
        t.active = !0;
        this.isRemove = !0;
        ...
        for (var e = 0; e < this.carRoot.children.length; e++) {
            ...
            if (
                o.getComponent($level_249667_carItem.default).prevCar ||
                o.getComponent($level_249667_carItem.default).nextCar ||
    ...
    e.prototype.removeCar = function(t) {
        ...
        cc.tween(this.dict.helicopterRoot)
            ...
            .call(function() {
                ...
                o.getComponent($level_249667_carItem.default).lenImgName = t.getComponent(
                    $level_249667_carItem.default
                ).lenImgName;
                o.getComponent($level_249667_carItem.default).colorImgName = t.getComponent(
                    $level_249667_carItem.default
                ).colorImgName;
                o.getComponent($level_249667_carItem.default).carColor = t.getComponent(
                    $level_249667_carItem.default
                ).carColor;
                if (
                    t.getComponent($level_249667_carItem.default).isTransportCar &&
                    -1 !== (i = e.transportCarArr.indexOf(t))
                ) {
                    e.transportCarArr.splice(i, 1);
                }
                if (
                    t.getComponent($level_249667_carItem.default).isUTransportCar &&
                    -1 !== (i = e.dict.carRoot.getComponent($level_249667_uTransport.default).carArr.indexOf(t))
                ) {
            ...
            .call(function() {
                ...
                t.getComponent($level_249667_carItem.default).carColor = o.getComponent(
                    $level_249667_carItem.default
                ).carColor;
                t.getComponent($level_249667_carItem.default).colorImgName = o.getComponent(
                    $level_249667_carItem.default
                ).colorImgName;
                t.getComponent($level_249667_carItem.default).lenImgName = o.getComponent(
                    $level_249667_carItem.default
                ).lenImgName;
                t.parking.car = t;
                t.parking.isEmpty = !1;
