...
var u = (function (t) {
    ...
    e.prototype.update = function () {
        if (!this.isReadyDestroy) {
                                ...
                                if (a[0]) {
                                    if (90 == e) {
                                        if (
                                            ...
                                            cc.Intersection.pointLineDistance(i[0], s[0], s[1], !0) < this.minLen ||
                                            cc.Intersection.pointLineDistance(i[0], h[0], h[1], !0) < this.minLen ||
                                            cc.Intersection.pointLineDistance(i[1], a[0], a[1], !0) < this.minLen ||
                                            cc.Intersection.pointLineDistance(i[1], s[0], s[1], !0) < this.minLen ||
                                        ...
                                        cc.Intersection.pointLineDistance(t, s[0], s[1], !0) < this.minLen ||
            ...
            if (
                this.carState == $level_29086_config.CarState.OutParking &&
            ...
            if (
                this.carState == $level_29086_config.CarState.WaterSprayLeave &&
