...
var k = (function (t) {
        ...
        if (i.length) {
            ...
            return (
                r.length &&
                    ...
                    r[0].runAction(this.shackAction(0.1, 2))),
                null
            );
        }
    };
    ...
    e.prototype.setBoxToPropClear = function (t, e) {
        ...
        for (
            var h = 0;
            h < a.length &&
            (s !== (m = a[h])[this.m_type] || (n.push(m), this.deleteFromArray(m, this.itemQueue), 0 != --r));
            h++
        ) {}
        if (r > 0) {
