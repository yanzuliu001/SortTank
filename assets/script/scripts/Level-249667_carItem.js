...
var u = (function (t) {
    ...
    e.prototype.update = function () {
        if (!this.isReadyDestroy) {
            if (this.carState == $level_249667_busConfig.CarState.Normal) {
                    ...
                    for (var r = 0; r < this.otherCarNode.length; r++) {
                        ...
                        try {
                            if (n && n.getComponent(o).carState == $level_249667_busConfig.CarState.Idle) {
                                var a = [
                                    n.convertToWorldSpaceAR(cc.v2(0, 0)),
                                    n.convertToWorldSpaceAR(cc.v2(0, -n.height))
                                ];
                                var c = [
                                    n.convertToWorldSpaceAR(cc.v2(-n.width / 2, 0)),
                                    n.convertToWorldSpaceAR(cc.v2(n.width / 2, 0))
                                ];
                                var h = [
                                    n.convertToWorldSpaceAR(cc.v2(-n.width / 2, -n.height)),
                                    n.convertToWorldSpaceAR(cc.v2(n.width / 2, -n.height))
                                ];
                                if (a[0]) {
                                    if (90 == e) {
                                        if (
                                            cc.Intersection.pointLineDistance(i[0], a[0], a[1], !0) < this.minLen ||
                                            cc.Intersection.pointLineDistance(i[0], c[0], c[1], !0) < this.minLen ||
                                            cc.Intersection.pointLineDistance(i[0], h[0], h[1], !0) < this.minLen ||
                                            cc.Intersection.pointLineDistance(i[1], a[0], a[1], !0) < this.minLen ||
                                            cc.Intersection.pointLineDistance(i[1], c[0], c[1], !0) < this.minLen ||
                                            cc.Intersection.pointLineDistance(i[1], h[0], h[1], !0) < this.minLen
                                        ) {
                                            this.checkTouch(n);
                                            break;
                                        }
                                    } else if (
                                        cc.Intersection.pointLineDistance(t, a[0], a[1], !0) < this.minLen ||
                                        cc.Intersection.pointLineDistance(t, c[0], c[1], !0) < this.minLen ||
                                        cc.Intersection.pointLineDistance(t, h[0], h[1], !0) < this.minLen
                                    ) {
                                        this.checkTouch(n);
                                        break;
                                    }
                ...
                if (this.node.y >= d.y - 2 * this.minLen) {
                    ...
                    if (this.isUTransportCar) {
                        if (
                            -1 !==
                            (r = this.mgr.dict.carRoot
                                .getComponent($level_249667_uTransport.default)
                                .carArr.indexOf(this.node))
                        ) {
                ...
                if (this.leftObliqueCar && this.node.x >= -189.008) {
                    ...
                    if (this.rightObliqueCar && this.node.x <= 189.008) {
                        ...
                        if (
                            ...
                            (-90 == Math.round(this.node.angle) ||
                                -52 == Math.round(this.node.angle) ||
                                -128 == Math.round(this.node.angle)) &&
                            this.node.x >= 0
                        ) {
                            (this.carState = $level_249667_busConfig.CarState.GoingRoad),
                                (this.node.x = 0),
                                this.mgr.changeCar(this.node, 2),
                                this.isUTransportCar &&
                                    this.mgr.dict.carRoot.getComponent($level_249667_uTransport.default).reduceUpdate();
                        } else {
                            (this.isUTransportCar || this.isUTransportCar_noIn) &&
                                (90 == Math.round(this.node.angle) ||
                ...
                if (this.isTramcar && this.railCarTurn[this.tramcarPosIndex]) {
                    ...
                    if ("0" == g) {
                        if (
                            this.getWPosByNode(this.node).x <=
                            this.getWPosByNode(this.railCarTurn[this.tramcarPosIndex]).x
                        ) {
                        ...
                        if ("1" == g) {
                            ...
                            "2" == g ||
                                ("3" == g &&
                                    this.getWPosByNode(this.node).y <=
                                        this.getWPosByNode(this.railCarTurn[this.tramcarPosIndex]).y &&
                                    this.railCarTurnChange(m));
                        }
                    }
                }
            ...
            if (
                this.carState == $level_249667_busConfig.CarState.OutParking &&
            ...
            if (
                this.carState == $level_249667_busConfig.CarState.WaterSprayLeave &&
            ...
            if ("leftUp" == t) {
                ...
                if ("leftDown" == t) {
                    ...
                    if ("right" == t) {
                        ...
                        "left" == t
                            ? ((this.tramcarPosIndex += 1), this.mgr.changeCar(this.node, 1, 2))
                            : "rightUp" == t
                            ? ((this.tramcarPosIndex += 1), this.mgr.changeCar(this.node, 4, 1))
                            : "rightDown" == t && ((this.tramcarPosIndex += 1), this.mgr.changeCar(this.node, 5, 1));
                    }
                }
            }
        }
    ...
    e.prototype.checkTouch = function (t) {
        ...
        if (
            n &&
            ((this.node.getChildByName("chain") &&
                0 == this.node.getChildByName("chain").getComponent($level_249667_chain.default).linkType) ||
                (n.getChildByName("chain") &&
                    0 == n.getChildByName("chain").getComponent($level_249667_chain.default).linkType))
        ) {
            n.stopAllActions();
        ...
        if (
            h &&
            ((h.getChildByName("chain") &&
                1 == h.getChildByName("chain").getComponent($level_249667_chain.default).linkType) ||
                (this.node.getChildByName("chain") &&
                    1 == this.node.getChildByName("chain").getComponent($level_249667_chain.default).linkType))
        ) {
    ...
    e.prototype.carBack = function (t) {
        ...
        if (
            ...
            ((this.node.getChildByName("chain") &&
                0 == this.node.getChildByName("chain").getComponent($level_249667_chain.default).linkType) ||
                (i.getChildByName("chain") &&
                    0 == i.getChildByName("chain").getComponent($level_249667_chain.default).linkType))
        ) {
            i.stopAllActions();
