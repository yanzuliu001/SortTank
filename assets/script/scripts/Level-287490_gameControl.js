...
var v = (function (t) {
    ...
    e.prototype.getTouchTarget = function (t) {
        ...
        for (var o = 0; o < this.boxRoot.children.length; o++) {
            ...
            if (
                i.getComponent($level_287490_boxItem.default).state == $level_287490_config.BoxState.Idle &&
                i.getBoundingBoxToWorld().contains(t)
            ) {
                e.push(i);
            }
        }
        e.sort(function (t, e) {
            return (
                e.getComponent($level_287490_boxItem.default).layer -
                    t.getComponent($level_287490_boxItem.default).layer ||
                e.getComponent($level_287490_boxItem.default).index -
                    t.getComponent($level_287490_boxItem.default).index
            );
        });
        return e[0];
    };
    ...
    e.prototype.playItemsIn = function () {
        ...
        e.sort(function (t, e) {
            return (
                t.y +
                1e3 * t.getComponent($level_287490_boxItem.default).layer -
                (e.y + 1e3 * e.getComponent($level_287490_boxItem.default).layer)
            );
                    ...
                    if (i.getComponent($level_287490_boxItem.default).state == $level_287490_config.BoxState.Idle) {
                        ...
                        for (var r = t.getBoxBoundingBox(i), n = o - 1; n >= 0; n--) {
                            ...
                            t.boxMap.get(a).forEach(function (e) {
                                if (
                                    e.getComponent($level_287490_boxItem.default).state ==
                                    $level_287490_config.BoxState.Idle
                                ) {
                                    var o = t.getBoxBoundingBox(e);
                                    if (r.intersects(o)) {
                                        i.getComponent($level_287490_boxItem.default).coverCount += e.getComponent(
                                            $level_287490_boxItem.default
                                        ).coverCount;
                                    }
                                }
                            });
    ...
    e.prototype.checkDrinkMove = function () {
        ...
        if (
            t.getComponent($level_287490_drinkItem.default).state == $level_287490_config.DrinkState.Idle &&
            !t.getComponent($level_287490_drinkItem.default).isAnim
        ) {
            var e = this.getWaitAllBox();
            for (var o = 0; o < e.length; o++) {
                var i = e[o];
                if (
                    t.getComponent($level_287490_drinkItem.default).colorType ==
                    i.getComponent($level_287490_boxItem.default).colorType
                ) {
