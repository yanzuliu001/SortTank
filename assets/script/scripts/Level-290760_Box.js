    ...
    (function (t) {
        ...
        e.prototype.getPath = function (t) {
            ...
            for (var h = 0; h < s.length; h++) {
                ...
                if (p != t) {
                    ...
                    if (
                        cc.Intersection.lineLine(o, i, d, u) ||
                        cc.Intersection.lineLine(o, i, g, m) ||
                        cc.Intersection.lineLine(r, n, d, u) ||
                        cc.Intersection.lineLine(r, n, g, m) ||
                        cc.Intersection.lineLine(o, i, f, v) ||
                        cc.Intersection.lineLine(o, i, f, v) ||
                        cc.Intersection.lineLine(r, n, f, v) ||
                        cc.Intersection.lineLine(r, n, f, v)
                    ) {
                        c = !0;
        ...
        e.prototype.getOtherBoxArrByDistance = function (t) {
            ...
            for (var o = 0; o < this.node.children.length; o++) {
                ...
                if (
                    ...
                    i != t &&
                    i.active &&
                    i.getComponent($level_290760_BoxItem.default).state == $level_290760_Enum.BoxState.Idle
                ) {
                    e.push(i);
                }
            }
            ...
            e.sort(function (t, e) {
                ...
                return (
                    cc.Intersection.pointLineDistance(r, o[0], o[1], !0) -
                    cc.Intersection.pointLineDistance(r, i[0], i[1], !0)
                );
            });
            return e;
        };
        e.prototype.setBoxID = function () {
            ...
            this.boxArrByIDSort.sort(function (t, e) {
                return (
                    t.getComponent($level_290760_BoxItem.default).path -
                    e.getComponent($level_290760_BoxItem.default).path
                );
            });
            this.boxArrByIDSort.forEach(function (e, o) {
                e.getComponent($level_290760_BoxItem.default).ID = o;
                e.getComponent($level_290760_BoxItem.default).percent = Math.round(
                    ((o + 1) / t.boxArrByIDSort.length) * 100
                );
                if (t.isTest) {
