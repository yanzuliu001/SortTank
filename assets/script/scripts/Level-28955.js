...
var k = (function (t) {
    ...
    e.prototype.setBoxSP = function (t, e) {
        t.getChildByName("sp").getComponent(cc.Sprite).spriteFrame = game.plateAtlas.getSpriteFrame(
            this.folder + "_" + e
        );
    };
            ...
            if ("1-1" == t.name) {
                ...
                if ("1-3" == t.name || "3-1" == t.name) {
                    ...
                    if ("2-2" == t.name) {
                        ...
                        "2-3" == t.name || "3-2" == t.name
                            ? ((n = cc.instantiate(this.dict["8-s"])).position = cc.v2(-5, 2))
                            : ("2-4" != t.name && "4-2" != t.name) ||
                              ((n = cc.instantiate(this.dict["10-s"])).position = cc.v2(-5, 2));
                    }
                }
            }
            n.name = "shadow";
    ...
    e.prototype.getItemType = function (t) {
        ...
        if (o.length) {
            ...
            var u = o[p].split("_")[0];
            if (
                (-28807 == this.levelID || -29055 == this.levelID) &&
    ...
    e.prototype.createItem = function (t, e, o) {
        ...
        a[this.m_posIndex] = t;
        a.name = String(e);
        a.getChildByName("sp").getComponent(cc.Sprite).spriteFrame = game.plateAtlas.getSpriteFrame(
            this.folder + "_" + r
        );
        this.setItemIndex(a);
