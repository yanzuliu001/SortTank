                                        ...
                                        return __awaiter(c, void 0, void 0, function () {
                                            ...
                                            return __generator(this, function (s) {
                                                switch (s.label) {
                                                    case 0:
                                                        s.trys.push([0, 2, , 3]);
                                                        return [4, this.downloadSpriteFrame(t, e)];
                                                    case 1:
                                                        r = s.sent();
                                                        return o && cc.isValid(o.node)
                                                            ? ((o.spriteFrame = new cc.SpriteFrame(r)),
                                                              this.tipsSize.equals(cc.v2())
                                                                  ? (n =
                                                                        this.node.getChildByName("node") ||
                                                                        this.node.children[0]) &&
                                                                    ((a = n.width / o.node.width),
                                                                    (c = n.height / o.node.height),
                                                                    (o.node.scale = Math.min(c, a)))
                                                                  : ((a = this.tipsSize.x / o.node.width),
                                                                    (c = this.tipsSize.y / o.node.height),
                                                                    (o.node.scale = Math.min(c, a))),
                                                              [2, i(!0)])
                                                            : [2, i(!0)];
                                                    case 2:
