                    ...
                    for (var e = 0; e < this.otherCarNode.length; e++) {
                        ...
                        try {
                            if (i && i.getComponent(o).carState == $level_249667_busConfig.CarState.Idle) {
                                var r = [
                                    i.convertToWorldSpaceAR(cc.v2(-i.width / 2, 0)),
                                    i.convertToWorldSpaceAR(cc.v2(-i.width / 2, -i.height))
                                ];
                                var n = [
                                    i.convertToWorldSpaceAR(cc.v2(i.width / 2, 0)),
                                    i.convertToWorldSpaceAR(cc.v2(i.width / 2, -i.height))
                                ...
                                if (
                                    ...
                                    cc.Intersection.pointLineDistance(t, r[0], r[1], !0) < this.minLen ||
                                    cc.Intersection.pointLineDistance(t, n[0], n[1], !0) < this.minLen
                                ) {
                                    this.checkTouch(i);
                                    break;
                                }
