...
var f = (function (t) {
    ...
    e.prototype.onLoad = function () {
        ...
        for (var r = 0; r < this.nodeUserPanel.children[0].children[0].childrenCount; r++) {
            i = (i = (i = (i = (i = (i = (i = (o = this.nodeUserPanel.children[0].children[0].children[r])
                .getComponent(cc.Label)
                .string.replace(/\u6d77\u5357\u4e50\u679c\u4e92\u5a31/g, t)).replace(
                /\u4e50\u679c\u4e92\u5a31/g,
                t
            )).replace(/\u4e50\u679c\u6e38\u620f/g, t)).replace(/\u4e50\u679c/g, t)).replace(
                /\u4e50\u679c/g,
                t
            )).replace(/leguo-kf@foxmail.com/g, e)).replace(
                /\u5e7f\u5dde\u5e02\u5929\u6cb3\u533a\u73e0\u6c5f\u65b0\u57ce\u73e0\u6c5f\u4e1c\u8def30\u53f7\u5e7f\u5dde\u94f6\u884c\u5927\u53a6601A/g,
                n
            );
        ...
        for (r = 0; r < this.nodePrivacyPanel.children[0].children[0].childrenCount; r++) {
            ...
            if ((o = this.nodePrivacyPanel.children[0].children[0].children[r]).getComponent(cc.Label)) {
                i = (i = (i = o.getComponent(cc.Label).string.replace(/\u5e7f\u5dde\u5c0f\u8d1d/g, t)).replace(
                    /xiaobei-kf@foxmail.com/g,
                    e
                )).replace(/\u5e7f\u5dde\u5e02\u5929\u6cb3\u533a\u73e0\u6c5f\u4e1c\u8def 30\u53f7601\u623f/g, n);
                o.getComponent(cc.Label).string = i;
            }
        }
        if (void 0 !== window.qq) {
