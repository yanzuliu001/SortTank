...
var l = (function (t) {
    ...
    e.prototype.getPosByUnify = function (t) {
        ...
        if (this._isHorizon) {
            ...
            n =
                0.5 * (e.width + this.spacingX) -
                ((this._col - (t % this._col)) * (e.width + this.spacingX) * 0.5 + (0.5 - e.anchorX) * e.width) +
                (t % this._col) * (e.width + this.spacingX) * 0.5;
    ...
    e.prototype._initialize = function () {
        if (this._isHorizon) {
            ...
            this._updateContentHeight();
            this._spawnCount = this._col * Math.ceil(this.node.height / this.itemPrefab.data.height) + 3 * this._col;
    ...
    e.prototype.update = function (t) {
        if (
            this._items.length == this._spawnCount &&
            ((this._updateTimer += t), !(this._updateTimer < this._updateInterval))
        ) {
            this._updateTimer = 0;
            var e = this._items;
            ...
            if (this._isHorizon) {
                ...
                for (i = 0; i < e.length; ++i) {
                    ...
                    if (u) {
                        ...
                        s.y > a.height + (1 - this.node.anchorY) * this.node.height &&
                        a.y - o >= -n.content.height
                    ) {
                        var f;
                        c = this._itemsUidToIndex[a.uuid];
                        l = 1;
