...
var v = new((function() {
    ...
    t.prototype.init = function() {
        ...
        var s = $localStorageManager.default.get($localStorageConst.default.value_pack) || !1;
        // try {
            ...
            for (var n = 0; n < window.getProductListJsonStr.length; n++) {
                ...
                if (r.product == e) {
                    t.getComponent(cc.Label).string =
                        r.oneTimePurchaseOfferDetails.zzc + r.oneTimePurchaseOfferDetails.zzb / 1e6;
                }
            }
        }
    };
    t.prototype.purchaseSuc = function() {
        ...
        switch (this.clickBuyID) {
            ...
            case "remove_ads_pack":
                ...
                $memoryStorageManager.default.set($memoryStorageConst.default.reward, [
                    ["card", 15],
                    ["skin", 15]
                ]);
