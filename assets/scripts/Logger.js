function o(t, e) {
    ...
    /(E+)/.test(e) &&
        (e = e.replace(
            RegExp.$1,
            (RegExp.$1.length > 1 ? (RegExp.$1.length > 2 ? "星期" : "周") : "") + "日一二三四五六".charAt(t.getDay())
        )),
    n))
...
exports.isLegalLogLevel = function (t) {
    return [
        exports.LOG_LEVEL.VERBOSE,
        exports.LOG_LEVEL.INFO,
        exports.LOG_LEVEL.WARNING,
        exports.LOG_LEVEL.ERROR,
        exports.LOG_LEVEL.NONE
    ].includes(t);
};
var i = (function () {
    function t(e, n) {
    ...
    t.prototype.getPrintPrefix = function (t) {
        ...
        return (
            "[wonder-js-sdk] " +
            o(new Date(), "yyyy-MM-ddThh:mm:ss.SZ") +
            " [" +
            t.toLocaleUpperCase() +
            "][" +
            this.prefix +
