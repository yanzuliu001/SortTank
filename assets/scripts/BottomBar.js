...
var A = (function (t) {
    ...
    e.prototype.boreBtn = function () {
        ...
        if (this.dict.boreTimes.active) {
            ...
            this.updateBoreView();
            return void $bmsManager.BMS.saveServerData(
    ...
    e.prototype.shareSucSub = function () {
        ...
        if ("restart" == t) {
            ...
            if ("tip" == t) {
                ...
                if ("bore" == t) {
                    $eventManager.Event.emit($eventConst.default.boreBtn),
                        $userManager.User.set($userConst.UserData.getBoreByShareTimes, 0);
                } else {
                    if ("delayed" == t) {
                        ...
                        "tip_timeEnd" == t
                            ...
                            : "addTime_timeEnd" == t
                            ? ($eventManager.Event.emit($eventConst.default.extendTime), $popupManager.default.hide())
                            : "bore_bore" == t
                            ? ($eventManager.Event.emit($eventConst.default.boreBtn), $popupManager.default.hide())
                            : "pause_answerBtn" == t &&
                              ($eventManager.Event.emit($eventConst.default.restartAnswer2),
