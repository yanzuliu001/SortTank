            ...
            return __generator(this, function (o) {
                switch (o.label) {
                    case 0:
                        if (t != $sceneConst.SceneConst.GAME || window.levelSub) {
                            if (this.isLoading) {
                                ...
                                return (
                                    (this.isLoading = !0),
                                    e && $popupManager.default.hideAll(),
                                    (n = "gameBundle"),
                                    $platformManager.Platform.getConfig().appID.includes("tt") &&
                                        t == $sceneConst.SceneConst.Home &&
                                        (n = "ttBundle"),
                                    [4, $assetManager.default.getRes(n, "prefab/scene/" + t, cc.Prefab)]
                                );
                            }
                        } else {
                            return (
                    ...
                    case 1:
                        ...
                        return this.hasAnim
                            ? ((this.transition.opacity = 0),
                              this.transition.stopAllActions(),
                              cc
