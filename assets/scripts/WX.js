...
var h = (function (t) {
    function e() {
        ...
        if (n.scene) {
            ...
            if (
                (1104 == e._inScene || 1103 == e._inScene) &&
            ...
            if (this._config.rewardID) {
                return void (
                    ...
                    this._rewardHasLoad && !this._rewardHasShow
                        ? ((this._rewardHasShow = !0), cc.game.emit("ad_show"), this._rewardAds.show())
        ...
        if (this.sdk.createBannerAd && this._config.bannerID) {
            if (this._banner) {
                this._banner &&
                    ...
                    t.top && (this._banner.style.top = t.top),
                    t.left && (this._banner.style.left = t.left));
            } else {
                (this._banner = this.sdk.createBannerAd({
                    adUnitId: t.id || this._config.bannerID,
                    style: {
