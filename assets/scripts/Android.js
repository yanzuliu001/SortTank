...
var l = (function (t) {
    ...
    e.prototype.bindEvents = function () {
        ...
        var e = {
            ...
            onNativeAdvanceBigBannerShow: function () {
            ...
            onInsertBannerImgClose: function () {
        ...
        this.insertCallBack = function (t) {
            if ("adCompleted" == t) {
                ...
                if ("adSkipped" == t) {
                    console.log("[AndroidAdCtrler][insertCallBack][adSkipped]"),
                        cc.game.emit("adSkipped"),
                        console.log("中途播放");
                } else {
                    if ("adsVideoFail" == t) {
                        console.log("[AndroidAdCtrler][insertCallBack][adsVideoFail]"),
                            cc.game.emit("adsVideoFail"),
                            (window.iOSSendMsg = function () {});
                    } else {
                        "insetVideoSuccess" == t &&
                            (cc.game.emit("insetVideoSuccess"),
                            console.log("[AndroidAdCtrler][insertCallBack][insetVideoSuccess]"));
                    }
                }
            }
        };
        this.rewardCallBack = function (e) {
            if ("adCompleted" == e) {
                ...
                if ("adSkipped" == e) {
                    console.log("[AndroidAdCtrler][rewardCallBack][videoUnfinish] 中途广告"),
                        cc.audioEngine.resumeAll(),
                        (window.iOSSendMsg = function () {}),
                        t._rewardAdsCb && t._rewardAdsCb(1),
                        (t._rewardAdsCb = null);
                } else {
                    if ("adsVideoFail" == e) {
                        console.log("[AndroidAdCtrler][rewardCallBack][adsVideoFail]"),
                            (window.iOSSendMsg = function () {}),
                            t._rewardAdsCb && t._rewardAdsCb(1),
                            (t._rewardAdsCb = null),
                            cc.audioEngine.resumeAll();
                    } else {
                        "rewardVideoSuccess" == e &&
                            (console.log("[AndroidAdCtrler][rewardCallBack][rewardVideoSuccess]"),
                            cc.audioEngine.pauseAll());
                    }
                }
            }
