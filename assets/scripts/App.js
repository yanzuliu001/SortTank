            ...
            return __generator(this, function(s) {
                switch (s.label) {
                    case 0:
                        ...
                        this.updateSkin();
                        // if (0 != (r = $bmsManager.BMS.getKey("AutoFullScreenAd"))) {
                        //     this.schedule(function() {
                        //         $platformManager.Platform.showInsert();
                        //     }, r);
                        // }
                    ...
                    case 5:
                        ...
                        if ($platformManager.Platform.is($platformConst.EPlatform.ANDROID_GOOGLE)) {
                            $bmsManager.BMS.getServerData(
                                $platformManager.Platform.getConfig().flag,
                                $userManager.User.get("googleID") || t,
                                ...
                                if (
                                    null == t[$userConst.UserData.boreTimes] ||
                                    Number(t[$userConst.UserData.boreTimes]) <= 0
                                ) {
                                    e = 0;
                                } else {
                                ...
                                if (
                                    null == t[$userConst.UserData.tipTimes] ||
                                    Number(t[$userConst.UserData.tipTimes]) <= 0
                                ) {
                                    n = 0;
                                } else {
                                ...
                                if (
                                    null == t[$userConst.UserData.screwBoxTimes] ||
                                    Number(t[$userConst.UserData.screwBoxTimes]) <= 0
                                ) {
                                    r = 0;
                                } else {
                                ...
                                if (
                                    null == t[$localStorageConst.default.cardAmount] ||
                                    Number(t[$localStorageConst.default.cardAmount]) <= 0
                                ) {
                                    o = 0;
                                } else {
                        ...
                        if ("haiwai" == $platformManager.Platform.getConfig().rank) {
                            ...
                            if (!U) {
                                $challengeHttp.challengeHttp.getCountry(!0).then(function(t) {
                                    ...
                                    if (0 == D.length) {
                                        ...
                                        if (D.includes(t)) {
                                            console.log("当前地区有内购1", t),
                                                ($platformManager.Platform.getConfig().hasPurchase = 1),
                                                cc.game.emit("hasPurchase");
                                        } else {
                                            console.log("当前地区没有内购1", t),
                                                ($platformManager.Platform.getConfig().hasPurchase = 0);
                                        }
                                    }
                                });
                                return [2];
                            ...
                            if (0 == D.length) {
                                ...
                                if (D.includes(U)) {
                                    console.log("当前地区有内购2", U),
                                        ($platformManager.Platform.getConfig().hasPurchase = 1);
                                } else {
                                    console.log("当前地区没有内购2", U),
                                        ($platformManager.Platform.getConfig().hasPurchase = 0);
                                }
                            }
                            if ("CN" == U) {
