...
var a = (function () {
    ...
    t.prototype.showLargeFeed = function () {
        ...
        if (t) {
            ...
            this.getResByChance($bmsManager.BMS.getKey("DownDT")[0]))
        ) {
            ...
            $platformManager.Platform.showNativeAds({
                ...
                container: cc
                    .find("Canvas")
                    .parent.getChildByName("myPersistRootNode")
                    .getChildByName("nativeBannerNode")
            });
        }
    };
            ...
            if (this.getResByChance(r)) {
                ...
                $platformManager.Platform.showNativeAds({
                    ...
                    container: cc
                        .find("Canvas")
                        .parent.getChildByName("myPersistRootNode")
                        .getChildByName("nativeInsertNode")
                });
            }
        }
    };
    ...
    t.prototype.showRewardVideo = function (t) {
        ...
        if (n) {
            ...
            ($platformManager.Platform.getConfig(), $platformManager.Platform.is($platformConst.EPlatform.OPPO))
        ) {
