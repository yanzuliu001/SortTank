    ...
    (function (t) {
                ...
                return __generator(this, function (s) {
                    switch (s.label) {
                        case 0:
                            ...
                            return t
                                ? ((this.dict.resultState1.active = !0),
                                  (this.dict.resultState0.active = !1),
                                  (this.dict.restartBtn.active = !0),
                                  (this.dict.nextBtn.active = !1),
                                  $audioManager.Audio.playEffect($audioConst.AudioConst.lose),
                                  (b = $userManager.User.getTempData("levelTime")),
                                  ...
                                  (this.dict.shareBtnText2.getComponent(cc.Label).string = "喊人"),
                                  this.dict.roleSpineFail &&
                                      ((i =
                                          $localStorageManager.default.get($localStorageConst.default.SkinList) ||
                                          {})[0] || (i[0] = [0]),
                                      i[1] || (i[1] = [0]),
                                      (a =
                                          $localStorageManager.default.get($localStorageConst.default.UseSkin) ||
                                          {})[0] || (a[0] = 0),
                                      a[1] || (a[1] = 0),
                                      this.loadSpine(
                                          "" + this.roleSpine[a[0]],
                                          this.dict.roleSpineFail.getComponent(sp.Skeleton),
                                          !0
                                      )),
                                  [3, 5])
                                : [3, 1];
                        case 1:
                            ...
                            return !e ||
                                r[0].includes(e) ||
                                0 != $userManager.User.getTempData($userConst.TempData.CURRENT_MODE)
                                ? [3, 3]
                                : ((this.dict.getGoodsRoot.active = !0),
                                  (this.dict.noGoodsRoot.active = !1),
                                  [
                                      4,
                                      $assetManager.default.getRes("gameBundle", "texture/collect/" + e, cc.Texture2D)
                                  ]);
                        case 2:
                            o = s.sent();
                            this.dict.winText.getComponent(cc.Label).string = $languageManager.default.formatStr(
                                "恭喜获得%s",
                                n
                            );
                        ...
                        case 4:
                            if (this.dict.roleSpineSuc) {
                                if (
                                    (i = $localStorageManager.default.get($localStorageConst.default.SkinList) || {})[0]
                                ) {
                                    //
                                } else {
                                    i[0] = [0];
                                ...
                                if (
                                    (a = $localStorageManager.default.get($localStorageConst.default.UseSkin) || {})[0]
                                ) {
                                    //
                                } else {
                                    a[0] = 0;
                                ...
                                this.loadSpine(
                                    "" + this.roleSpine[a[0]],
                                    this.dict.roleSpineSuc.getComponent(sp.Skeleton)
                                );
                            }
                            ...
                            this.dict.time.getComponent(cc.Label).string = $languageManager.default.formatStr(
                                "累计用时%d分%d秒",
                                Number(T[0]),
                                Number(T[1])
                            );
                            ...
                            if ($userManager.User.get($userConst.UserData.todayFirstPass)) {
                                ...
                                $challengeHttp.challengeHttp
                                    .incrRank(F, $userManager.User.get(A), 1)
                                    .then(function (t) {
                                        console.log("上传一次数据", t);
                                    });
                            }
                            if (
                                0 == (j = $userManager.User.getTempData($userConst.TempData.CURRENT_MODE)) &&
                                $platformManager.Platform.getConfig().flag.includes("wx")
                            ) {
                            ...
                            if (window.f29086_dragonBall) {
                                ...
                                $localStorageManager.default.set(
                                    $localStorageConst.default.DragonBall,
                                    W + window.f29086_dragonBall
                                );
                            }
                            if (window.f29086_coin) {
                                X = $localStorageManager.default.get($localStorageConst.default.Coin) || 0;
                                $localStorageManager.default.set(
                                    $localStorageConst.default.Coin,
                                    X + window.f29086_coin
                                );
                            }
                            this.scheduleOnce(function () {
                ...
                return __generator(this, function (a) {
                    switch (a.label) {
                        case 0:
                            ...
                            return t || e < 2 || 0 != n
                                ? [2, (this.dict.mapBtn.active = !1)]
                                : [4, $configManager.Config.get($configConst.ConfigConst.City)];
                        case 1:
                            (r = a.sent()).sort(function (t, e) {
                                return t.sort - e.sort;
                            });
                            o = $memoryStorageManager.default.get($memoryStorageConst.default.CurrentChallengeCity);
                            this.dict.city.getComponent(cc.Label).string =
                                "激活城市：" +
                                r.find(function (t) {
                                    return t.id == o;
                                }).cityID;
                        ...
                        case 0:
                            if (t) {
                                ...
                                if (0 != ($userManager.User.getTempData($userConst.TempData.CURRENT_MODE) || 0)) {
                                    ...
                                    return (
                                        (e =
                                            $memoryStorageManager.default.get(
                                                $memoryStorageConst.default.IsDailyChallenge
                                            ) || 0),
                                        (this.dict.newElementRoot.active = !e),
                                        (this.dict.nextBtn.active = !e),
                                        (n = $userManager.User.getTempData($userConst.TempData.CURRENT_LEVEL)),
                                        (r =
                                            $localStorageManager.default.get($localStorageConst.default.ConfigSuffix) ||
                                            0),
                                        e ? [3, 7] : [4, $configManager.Config.get($configConst.ConfigConst.Feature)]
                                    );
                                }
                            }
                        case 1:
                                      ...
                                      : ((l = n),
                                        ...
                                        [
                                            ...
                                            $assetManager.default.getRes(
                                                "resources",
                                                "texture/mode/icon_yuansu" + a.featureID,
                                                cc.Texture2D
                                            )
                                        ]))
                                : [3, 6];
                        ...
                        case 2:
                            ...
                            return e && cc.isValid(e.node)
                                ? ((c = new sp.SkeletonData()),
                                  ...
                                  (l = "shengli"),
                                  n && (l = "shibai"),
                                  console.log("isFail", n, l),
                                  1 == this.assetAssignmentType &&
                                      ((e.skeletonData = c),
                                      e.setSkin("default"),
                                      (e.defaultSkin = "default"),
                                      c.getRuntimeData() &&
                                          ((e.defaultAnimation = l || c.getRuntimeData().animations[0].name),
                                          e.setAnimation(0, l || c.getRuntimeData().animations[0].name, e.loop))),
                                  [3, 4])
                                : [2];
                        case 3:
                            u = s.sent();
        ...
        e.prototype.clickNext = function () {
            if (!this.isLoading) {
                ...
                var e =
                    ($userManager.User.getTempData($userConst.TempData.CURRENT_MODE),
                    $userManager.User.getTempData("newPass") || !1);
