            ...
            return __generator(this, function (i) {
                switch (i.label) {
                    ...
                    case 1:
                        ...
                        return 0 != this.skinType
                            ? [3, 3]
                            : [4, $configManager.Config.get($configConst.ConfigConst.Skin)];
                    case 2:
                        r = i.sent();
                        return [3, 5];
                    case 3:
                    ...
                    case 5:
                        switch (
                            ((this.dict.name.getComponent(cc.Label).string = r.find(function (e) {
                                return e.id - 1 == t;
                            }).skinName),
                            this.state)
                        ) {
                            ...
                            case c.lockByVideo:
                                if (
                                    (o =
                                        $localStorageManager.default.get($localStorageConst.default.SkinUnlockVideo) ||
                                        {})[t]
                                ) {
                                    //
                                } else {
