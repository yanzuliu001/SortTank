                    ...
                    if (a > 1) {
                        if (1 == r) {
                            ...
                            if (2 == r) {
                                ...
                                if (3 == r) {
                                    (c = $userManager.User.get($userConst.UserData.boreTimes) || 0),
                                        (c += a - 1),
                                        $userManager.User.set($userConst.UserData.boreTimes, c),
                                        cc.game.emit("updateBoreView");
                                } else {
                                    0 == r &&
                                        ((c = $userManager.User.get("restartTimes") || 0),
                                        (c += a - 1),
                                        $userManager.User.set("restartTimes", c),
