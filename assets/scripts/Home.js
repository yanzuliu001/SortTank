...
var q = (function (t) {
    ...
    e.prototype.shipBtn = function () {
        ...
        if ($localStorageManager.default.get($localStorageConst.default.todayShipExpire)) {
            ...
            if (this.dict.shipTime.parent.active) {
                $memoryStorageManager.default.set($memoryStorageConst.default.openShipWay, "home"),
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (s) {
                switch (s.label) {
                    ...
                    case 1:
                        for (
                            e = s.sent(), $userManager.User.setTempData($userConst.TempData.CURRENT_ALL_MODE, e), A = 0;
                            A < e.length;
                            A++
                        ) {
                            o = e[A].theme;
                        ...
                        if ($userManager.User.get($userConst.UserData.FIRST_DAY_DATE)) {
                            ...
                            if (
                                ...
                                ((p = $userManager.User.get($userConst.UserData.IS_COMPATIBLE_233) || 0),
                                console.log("是否已经兼容", p),
                                !p)
                            ) {
                                for (P in ((_ = $userManager.User.get($userConst.UserData.LEVEL_LIST)),
                                console.log("levelList", JSON.stringify(_)),
                                (k = {}),
                                (M = {}),
                                _)) {
                                    T = _[P];
                            ...
                            for (P in ($userManager.User.set($userConst.UserData.FIRST_DAY_DATE, new Date().getDate()),
                        ...
                        this.dict.version.getComponent(cc.Label).string =
                            "v" + $platformManager.Platform.getConfig().version;
                        ...
                        if (
                            ...
                            $platformManager.Platform.getConfig().hasVIP &&
                            H &&
                            !q &&
                            2 == z
                        ) {
                        ...
                        if (this.dict.vipTime) {
                            if (q) {
                                (this.dict.vipTime.active = !0),
                                    (this.dict.vipTime.getComponent(cc.Label).string =
                                        $vIPSystem.default.getSurplusTimeStr());
                            } else {
                        ...
                        if (this.dict.vipBtn) {
                            if ($platformManager.Platform.getConfig().hasPurchase) {
                                (this.dict.shopBtn.active = !0),
                                    $platformManager.Platform.getConfig().hasVIP && (this.dict.vipBtn.active = !0),
                                    (this.dict.universalCard.active = !0),
                                    (this.dict.turntableBtn.active = !0);
                            } else {
                                (this.dict.noADBtn.active = !1),
                                    (this.dict.specialBtn.active = !1),
                                    (this.dict.vipBtn.active = !1),
                                    (this.dict.shopBtn.active = !1),
                                    (this.dict.universalCard.active = !1),
                                    (this.dict.shipBtn.active = !1),
                                    (this.dict.turntableBtn.active = !1),
                                    (this.dict.newHandBtn.active = !1),
                                    (this.dict.supervalueBtn.active = !1);
                            }
                        }
                        ...
                        if (this.dict.challengeTime) {
                            if (lt) {
                                (this.dict.challengeHint.active = !ct),
                                    (this.dict.challengeTime.parent.active = !0),
                                    (this.dict.challengeTime.getComponent(cc.Label).string =
                                        $challengeSystem.default.getSurplusTimeStr());
                            } else {
    ...
    e.prototype.carMove1 = function () {
        ...
        e.opacity = 255;
        cc.tween(e)
            .by((cc.winSize.width + 200) / this.carSpeed, {
    ...
    e.prototype.carMove2 = function () {
        ...
        e.opacity = 255;
        cc.tween(e)
            .by((cc.winSize.width + 300) / this.carSpeed, {
    ...
    e.prototype.sucGetRank = function () {
        ...
        this.myRank = n + 1;
        this.dict.myRank.getComponent(cc.Label).string = $languageManager.default.formatStr(
            "我的地区排名：第%d名",
            this.myRank
        );
        cc.tween(this.dict.todayAmount)
            .delay(3)
            .to(2, {
                x: -750
            })
        ...
        $challengeHttp.challengeHttp.getRank(a, "1").then(function (t) {
            ...
            if (t.total) {
                var n = 0;
                for (var r in t.list) n += t.list[r].score;
                e.dict.todayAmount.getComponent(cc.Label).string = $languageManager.default.formatStr(
                    "今天%d人挑战，共有%d人通关",
                    18 * n + $utils.Utils.randomNum(10, 20),
                    n
                );
            } else {
                if ("haiwai" == $platformManager.Platform.getConfig().rank) {
                ...
                e.dict.todayAmount.getComponent(cc.Label).string = $languageManager.default.formatStr(
                    "今天%d人挑战，共有%d人通关",
                    1782 + $utils.Utils.randomNum(10, 20),
                    99
                );
            }
        });
