(function (r) {
    ...
    o = function () {
        ...
        d.mode.ECB =
            (((l = d.lib.BlockCipherMode.extend()).Encryptor = l.extend({
                processBlock: function (t, e) {
        ...
        d.mode.OFB =
            ((f = (u = d.lib.BlockCipherMode.extend()).Encryptor =
                u.extend({
                    processBlock: function (t, e) {
                        var n = this._cipher;
                        var r = n.blockSize;
        ...
        (function () {
            ...
            var m = (n.AES = e.extend({
                ...
                _doCryptBlock: function (t, e, n, r, o, i, a, s) {
                    ...
                    m =
                        ((s[l >>> 24] << 24) | (s[(u >>> 16) & 255] << 16) | (s[(f >>> 8) & 255] << 8) | s[255 & d]) ^
                        n[h++];
                    g =
                        ((s[u >>> 24] << 24) | (s[(f >>> 16) & 255] << 16) | (s[(d >>> 8) & 255] << 8) | s[255 & l]) ^
                        n[h++];
                    y =
                        ((s[f >>> 24] << 24) | (s[(d >>> 16) & 255] << 16) | (s[(l >>> 8) & 255] << 8) | s[255 & u]) ^
                        n[h++];
                    v =
                        ((s[d >>> 24] << 24) | (s[(l >>> 16) & 255] << 16) | (s[(u >>> 8) & 255] << 8) | s[255 & f]) ^
                        n[h++];
                    t[e] = m;
                    t[e + 1] = g;
                    t[e + 2] = y;
        ...
        (function () {
            ...
            var a = (n.Rabbit = e.extend({
                _doReset: function () {
                    ...
                    for (var n = 0; n < 4; n++) {
                        t[n] =
                            (16711935 & ((t[n] << 8) | (t[n] >>> 24))) | (4278255360 & ((t[n] << 24) | (t[n] >>> 8)));
                    }
                    var r = (this._X = [
                        t[0],
                        (t[3] << 16) | (t[2] >>> 16),
                ...
                _doProcessBlock: function (t, e) {
                    ...
                    for (var o = 0; o < 4; o++) {
                        r[o] =
                            (16711935 & ((r[o] << 8) | (r[o] >>> 24))) | (4278255360 & ((r[o] << 24) | (r[o] >>> 8)));
                        t[e + o] ^= r[o];
                    }
                },
                blockSize: 4,
